...
class MongoDBUserStoreConstants {
    ...
    static {
        setMandatoryProperty(MongoDBRealmConstants.URL, "Connection URL", "", "URL of the user store database", false);
        setMandatoryProperty(MongoDBRealmConstants.USER_NAME, "Connection Name", "", "Username for the database", false);
        setMandatoryProperty(MongoDBRealmConstants.PASSWORD, "Connection Password", "", "Password for the database", true);
        setMandatoryProperty(MongoDBRealmConstants.PORT, "Connection port", "", "Port of MongoDB server running", false);
        ...
        setAdvancedProperty("UpdateRoleNameMONGO_QUERY", "{'collection' : 'UM_ROLE','UM_ID' : '?','UM_TENANT_ID' : '?','projection' : {'$set' : {'UM_ROLE_NAME' : '?'}}}");
